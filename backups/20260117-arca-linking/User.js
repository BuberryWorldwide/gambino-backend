...
const userSchema = new mongoose.Schema({
  ...
  kycVerifiedAt: Date,
  kycVerifiedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User' }, // Staff who verified
  kycVerifiedAtVenue: { type: String },  // Venue/store ID where verified
  kycVerificationMethod: {
    type: String,
    enum: ['in_person', 'document_upload'],
    default: 'in_person'
  },
  kycNotes: { type: String },  // Staff notes (e.g., "Verified state ID")
  ...
  // Security & Access
  password: { type: String, select: false }, // Hashed password for admin/venue manager login
  ...
  // Arca Entropy Linking
  linkedArcaIds: [{ type: String }], // Anonymous IDs like anon-abc123 from Arca Fabric
